		...
		<table class="contentpaneopen<?php echo $params->get( 'pageclass_sfx' ); ?>">
			<tr>
				<td nowrap="nowrap">
					...
					<br/>
					<input type="text" name="searchword" id="search_searchword" size="60" maxlength="60" value="<?php echo stripslashes($searchword);?>" class="inputbox" />
					<br/>
