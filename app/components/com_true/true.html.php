	...
	function showPictures($option, &$rows, &$clist, &$slist, &$search, &$pageNav)
		...
		?>
			<form action="index2.php" method="post" name="adminForm">
				<table cellpadding="4" cellspacing="0" border="0" width="680" class="adminheading">
					<tr>
				...
				<table cellpadding="4" cellspacing="0" border="0" width="680" class="adminlist">
					<tr>
		...
		$ad_pathoriginals, $ad_pathimages, $ad_paththumbs, $ad_path, $ad_thumbwidth, $ad_thumbheight, $ad_imgstyle)
			{
			    ...
			    <table width="680" border="0" cellspacing="0" cellpadding="6" class="adminform" style="table-layout: auto; white-space: nowrap;">
			    <tr>
		...
		function showCatOverview($option,  $total, $catid, $lists, $pageNav, $search)
			{
				...
				<table width="680" border="0" cellpadding="4" cellspacing="0"  class="adminlist">
					<tr>
				    	<th width="24px">#</th>
