...
?>
<link href="<?php echo $siteurl; ?>/components/com_jcomments/tpl/<?php echo $this->getVar('template'); ?>/style.css" rel="stylesheet" type="text/css" />
<?php
			}
