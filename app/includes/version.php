...
class joomlaVersion {
	...
	/** @var string Date */
	var $RELDATE 	= '19 мая 2008';
	/** @var string Time */
	var $RELTIME 	= '00:01';
	/** @var string Timezone */
	var $RELTZ 		= 'UTC';
	/** @var string Copyright Text */
	var $COPYRIGHT 	= "Авторские права (C) 2005-2008 OSM. Все права защищены.";
	/** @var string URL */
	var $URL 		= '<a href="http://andyr.mrezha.ru">Joomla Lavra Edition! 2008</a> свободно распространяемое программное обеспечение по лицензии GNU';
