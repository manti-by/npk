...
class gacl_api extends gacl {
	...
	function get_group_id($name = null, $group_type = 'ARO') {
		...
		$this->debug_text("get_group_id(): Имя: $name");
	...
	function add_group($name, $parent_id=0, $group_type='ARO') {
		...
		$this->debug_text("add_group(): Имя: $name Parent ID: $parent_id Group Type: $group_type");
...
//			SELECT		g.group_id,o.'. $group_type .'_id,(gm.group_id IS NOT NULL) AS member
	...
	function add_object($section_value, $name, $value=0, $order=0, $hidden=0, $object_type=NULL) {
		...
		$this->debug_text("add_object(): Значение раздела: $section_value Значение: $value Порядок: $order Имя: $name Object Тип: $object_type");
	...
	function edit_object($object_id, $section_value, $name, $value=0, $order=0, $hidden=0, $object_type=NULL) {
		...
		$this->debug_text("edit_object(): ID: $object_id, Значение раздела: $section_value, Значение: $value, Порядок: $order, Имя: $name, Тип объекта: $object_type");
