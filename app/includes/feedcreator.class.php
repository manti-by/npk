 ...
 * Version string.
 **/
define("FEEDCREATOR_VERSION", "FeedCreator 1.7.2 - RUS Patches by AndyR");
	...
	*/
	...
	function saveFeed($filename="", $displayContents=true) {
		...
		if ($feedFile) {
			...
			echo "<br /><b>Ошибка создания файла ленты, проверьте доступ на запись на папку кэша!</b><br />";
		}
	}
...
class HTMLCreator extends FeedCreator {
	...
	function createFeed() {
		global $cur_template;
	    $this->header = '<link rel="stylesheet" href="templates/'.$cur_template.'/css/template_css.css" type="text/css" />';
