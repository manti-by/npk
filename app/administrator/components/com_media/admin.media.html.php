...
class HTML_Media {
							...
							<tr>
								...
								<td class="buttonOut" width="10">
									<a href="javascript:dirup()">
										<img src="components/com_media/images/btnFolderUp.gif" width="15" height="15" border="0" alt="Наверх" />
									</a>
								</td>
								<td align="right">
									Загрузка файла <small>[ максимум = <?php echo ini_get( 'post_max_size' );?> ]</small>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td>
				<div align="center" style="font-size:small;font-weight:bold;color:#CC0000;font-family: Helvetica, sans-serif;">
					Проблемы конфигурации: &quot;<?php echo $BASE_DIR.$BASE_ROOT; ?>&quot; не существует.
				</div>
			</td>
		</tr>
		</table>
	...
	function show_image($img, $file, $info, $size, $listdir) {
		...
		$overlib .= '</tr>';
		$overlib .= '</table>';
		$overlib .= '<br/> *Щелкните для просмотра*';
		$overlib .= '<br/> *Щелкните для отображения URL_кода*';
		?>
		<div style="float:left; padding: 5px">
			...
			<div class="imginfoBorder">
				...
				<div class="buttonOut">
					<a href="index2.php?option=com_media&amp;task=delete&amp;delFile=<?php echo $file; ?>&amp;listdir=<?php echo $listdir; ?>" target="_top" onclick="return deleteImage('<?php echo $file; ?>');" title="Удалить объект">
						<img src="components/com_media/images/edit_trash.gif" width="15" height="15" border="0" alt="Удалить" /></a>
					<a href="#" onclick="javascript:window.top.document.forms[0].imagecode.value = '<img src=&quot;<?php echo $img_url_link;?>&quot; align=&quot;left&quot; hspace=&quot;6&quot; alt=&quot;Картинка&quot; />';" title="Код картинки">
						<img src="components/com_media/images/edit_pencil.gif" width="15" height="15" border="0" alt="Код" /></a>
				</div>
			</div>
		</div>
		<?php
	...
	function show_dir( $path, $dir, $listdir ) {
		...
		$overlib .= '</tr>';
		$overlib .= '</table>';
		$overlib .= '<br/> *Щелкните для открытия*';
		?>
		<div style="float:left; padding: 5px">
	...
	function show_doc($doc, $size, $listdir, $icon) {
		...
		$overlib = 'Размер: '. $size;
		$overlib .= '<br/><br/> *Щелкните для отображения URL_кода*';
		?>
		<div style="float:left; padding: 5px">
			<div class="imgTotal" onmouseover="return overlib( '<?php echo $overlib; ?>', CAPTION, '<?php echo $doc; ?>', BELOW, RIGHT, WIDTH, 200 );" onmouseout="return nd();">
				<div align="center" class="imgBorder">
				  <a href="index3.php?option=com_media&amp;task=list&amp;listdir=<?php echo $listdir; ?>" onclick="javascript:window.top.document.forms[0].imagecode.value = '<a href=&quot;<?php echo $doc_url_link;?>&quot;>Вставьте ваш текст здесь</a>';">
