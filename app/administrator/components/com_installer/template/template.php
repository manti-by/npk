...
HTML_installer::showInstallForm( 'Установить новый шаблон <small><small>[ ' . ($client == 'admin' ? 'Админка' : 'Сайт') .' ]</small></small>',
	$option, 'template', $client, $userfile,
	'<a href="index2.php?option=com_templates&client='.$client.'">Назад в шаблоны</a>'
);
?>
<table class="content">
<?php
