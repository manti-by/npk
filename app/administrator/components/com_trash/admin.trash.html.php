...
class HTML_trash {
	...
	*/
	function showList( $option, $content, $pageNav, $list, $catid ) {
		...
		*/
		...
		<tr>
			<th class="trash">Менеджер корзины</th>
			<td width="right">
				<?php echo $list; ?>
			</td>
		</tr>
		...
		<tr>
			...
			<th>
			<?php echo ($catid=="content") ? "Раздел" : "Меню"; ?>
			</th>
			<th>
			<?php echo ($catid=="content") ? "Категория" : "Тип"; ?>
			</th>
			<th width="70px">
			ID
			</th>
	...
	*/
	...
	?>
		...
		<tr>
			...
			<strong>Объекты для удаления:</strong>
			<br />
			<?php
			echo "<ol>";
			...
			?>
			 ...
			 <td valign="top">
			* Эти объекты будут <strong><font color="#FF0000">безвозвратно удалены</font></strong>*
			<br /><br /><br />
			<div style="border: 1px dotted gray; width: 70px; padding: 10px; margin-left: 50px;">
			<a class="toolbar" href="javascript:if (confirm('Вы уверены, что хотите удалить объекты, оговоренные в списке? \nОни будут удалены без возможности восстановления.')){ submitbutton('delete');}" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('remove','','images/delete_f2.png',1);">
	...
	*/
	...
	?>
		...
		<table class="adminheading">
		<tr>
			<th>Восстановление объекта(ов)</th>
		</tr>
		</table>
		...
		<tr>
			...
			<td align="left" valign="top" width="25%">
			<strong>Объекты для восстановления:</strong>
			<br />
			<?php
			echo "<ol>";
			foreach ( $items as $item ) {
			...
			?>
			 ...
			 <td valign="top">
			* Это объекты будут <strong><font color="#FF0000">восстановлены</font></strong> ,<br />они будут возвращены на старое место но с них будет снята публикация *
			<br /><br /><br />
			<div style="border: 1px dotted gray; width: 80px; padding: 10px; margin-left: 50px;">
			<a class="toolbar" href="javascript:if (confirm('Вы уверены, что хотите восстановить объекты, оговоренные в списке?.')){ submitbutton('restore');}" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('restore','','images/restore_f2.png',1);">
