	...
	function edit( &$row, $option, &$lists, &$menus ) {
		...
		<tr>
			<td valign="top" width="60%">
				...
				<tr>
					<td>
					Имя: <?php echo (isset($row->section) ? "категории" : "раздела");?>
					</td>
					<td colspan="2">
					<input class="text_area" type="text" name="name" value="<?php echo $row->name; ?>" size="50" maxlength="255" title="Длинное имя для заголовков" />
					</td>
				</tr>
				<tr>
					<td>
	...
	*/
	function copySectionSelect( $option, $cid, $categories, $contents, $section ) {
		...
		<tr>
			...
			<br />
			<input class="text_area" type="text" name="title" value="" size="35" maxlength="50" title="Имя нового раздела" />
			<br /><br />
			</td>
			...
			<br />
			и всех материалов внутри категории (тоже показаны)
			<br />
			в новый созданный раздел.
			</td>.
		</tr>
		</table>
		<br /><br />
