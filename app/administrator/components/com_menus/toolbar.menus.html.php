...
class TOOLBAR_menus {
	...
	*/
	function _NEW()	{
		...
		mosMenuBar::customX( 'edit', 'next.png', 'next_f2.png', 'Дальше', true );
		mosMenuBar::spacer();
		mosMenuBar::cancel();
		mosMenuBar::spacer();
	...
	*/
	function _EDIT() {
		...
		mosMenuBar::startTable();
		if ( !$id ) {
			$link = 'index2.php?option=com_menus&menutype='. $menutype .'&task=new&hidemainmenu=1&' . josSpoofValue() . '=1';							mosMenuBar::back( 'Назад', $link );
