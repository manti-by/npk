	...
	function edit( &$menu, &$components, &$lists, &$params, $option ) {
		...
		function submitbutton(pressbutton) {
			...
			if ( trim( form.name.value ) == "" ){
				alert( "Пункт меню должен иметь имя" );
		...
		<tr>
			<th>
			<?php echo $menu->id ? 'Изменить' : 'Добавить';?> Пункт меню :: компонент <small><small><?php echo $title; ?></small></small>
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					<td width="10%" align="right">Имя:</td>
					<td width="80%">
			...
			<td width="40%">
				...
				<tr>
					...
					if ($menu->id) {
						...
						?>
						<strong>Список параметров станет доступным после сохранения пункта меню</strong>
						<?php
					}
					?>
					</td>
