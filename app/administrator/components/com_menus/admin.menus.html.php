...
class HTML_menusections {
	...
	function showMenusections( $rows, $pageNav, $search, $levellist, $menutype, $option ) {
		...
		<tr>
			<th class="menus">
			Менеджер меню <small><small>[ <?php echo $menutype;?> ]</small></small>
			</th>
			<td nowrap="true">
			Максимально уровней
			</td>
	...
	*/
	function addMenuItem( &$cid, $menutype, $option, $types_content, $types_component, $types_link, $types_other, $types_submit ) {
		...
		<tr>
			...
			* Помните, что некотрые типы меню могут находиться сразу в нескольких группах но выполнять одно и то же действие
			</td>
		</tr>
		</table>
	...
	*/
	function moveMenu( $option, $cid, $MenuList, $items, $menutype  ) {
		...
		<tr>
			...
			<strong>Перенести в меню:</strong>
			<br />
			<?php echo $MenuList ?>
			<br /><br />
			</td>
