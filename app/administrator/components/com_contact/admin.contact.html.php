		...
		for ($i=0, $n=count($rows); $i < $n; $i++) {
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				if ( $row->checked_out && ( $row->checked_out != $my->id ) ) {
					...
					?>
					<a href="<?php echo $link; ?>" title="Редактировать контакт">
					<?php echo $row->name; ?>
					</a>
					<?php
				}
				...
				<td>
				<a href="<?php echo $row->user_link; ?>" title="Редактировать пользователя">
				<?php echo $row->user; ?>
				</a>
				</td>
			</tr>
	...
	function editContact( &$row, &$lists, $option, &$params ) {
		...
		<tr>
			...
			<td width="40%" valign="top">
				...
				<tr>
					<th>
					Параметры отображения контакта
					</th>
				</tr>
				<tr>
					<td>
					* Эти параметры работают только когда пользователь щелкнет по контакту для его просмотра *
					<br /><br />
					</td>
				</tr>
				<tr>
