	...
	*/
	...
	function system_info( $version ) {
		...
		?>
			...
			<tr>
				<td>
					<strong>WebServer - PHP интерфейс:</strong>
				</td>
				<td>
			...
			<tr>
				<td valign="top">
					<strong>Установки PHP:</strong>
				</td>
				<td>
					<table cellspacing="1" cellpadding="1" border="0">
					<tr>
						<td width="250">
							Joomla! Register Globals эмуляция:
						</td>
		...
		?>
			...
			<tr>
				<td>
					<strong>Для нормальной работы Joomla Lavra! все перечисленные каталоги должны быть доступны для записи:</strong>
					<?php
					...
					mosHTML::writableCell( $mosConfig_cachepath, 0, '<strong>Папка кэша</strong> ' );
					mosHTML::writableCell( $sp, 0, '<strong>Папка хранения сессий</strong> ' );
					?>
				</td>
			</tr>
			</table>
					...
					<tr>
						<td>
							...
							<a href="<?php echo $mosConfig_live_site;?>/administrator/index3.php?option=com_admin&task=sysinfo" target="helpFrame">
								Системная мнформация</a>
							|
							<a target="_blank" href="http://andyr.mrezha.ru/index.php?option=com_content&task=view&id=26&Itemid=49" target="_blank">
								Проверка последней версии</a>
						</td>
					</tr>
				</table>
			</td>
