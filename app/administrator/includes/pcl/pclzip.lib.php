...
if (!function_exists('gzopen'))
{
  ...
  die('Отмена '.basename(__FILE__).' : отсутствует ZLIB расширение');
}
...
if ($v_size == 2) {
  ...
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER,
			"Неверное количество/тип аргументов");
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Недопустимый переменный тип p_filelist");
...
if ($v_size == 2) {
  ...
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Неверное количество/тип аргументов");
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Неверный переменный тип p_filelist");
  $v_result = PCLZIP_ERR_INVALID_PARAMETER;
}
...
if ($v_size <= 0) {
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Отсутствуют аргументы");
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Как минимум один фильтр должен быть установлен");
...
if (@is_file($this->zipname))
{
  ...
  {
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Не могу открыть архив \''.$this->zipname.'\' в бинарном режиме');
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_MISSING_FILE, "Нет файла с именем '".$p_archive."'");
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Неверный переменный тип p_archive_to_add");
  $v_result = PCLZIP_ERR_INVALID_PARAMETER;
}
...
if (!is_file($this->zipname)) {
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_MISSING_FILE, "Отсутствует архивный файл '".$this->zipname."'");
...
if (!is_readable($this->zipname)) {
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, "Не могу прочитать архив '".$this->zipname."'");
  //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, false, PclZip::errorInfo());
  return(false);
}
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Неверный опциональный параметр '".$p_options_list[$i]."' для этого метода");
...
case PCLZIP_OPT_ADD_PATH :
  ...
  if (($i+1) >= $p_size) {
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_MISSING_OPTION_VALUE, "Отсутствует значение парметра '".PclZipUtilOptionText($p_options_list[$i])."'");
...
case PCLZIP_OPT_BY_NAME :
  ...
  if (($i+1) >= $p_size) {
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_MISSING_OPTION_VALUE, "Отсутствует значение парметра для опции '".PclZipUtilOptionText($p_options_list[$i])."'");
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Неверное значение парметра для опции '".PclZipUtilOptionText($p_options_list[$i])."'");
...
PclZip::privErrorLog(PCLZIP_ERR_MISSING_OPTION_VALUE,
			 "Отсутствует значение парметра для опции '"
...
PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE,
			 "Неверное значение парметра для опции '"
								 .PclZipUtilOptionText($p_options_list[$i])
								 ."'");
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Значение должно быть числом, строкой или массивом для '".PclZipUtilOptionText($p_options_list[$i])."'");
...
return PclZip::errorCode();
  ...
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Слишком много значений в диапазоне индексов для опции '".PclZipUtilOptionText($p_options_list[$i])."'");
  ...
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Неверный порядок диапазона индексов для опции '".PclZipUtilOptionText($p_options_list[$i])."'");
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Функция '".$v_function_name."()' не существующая для опции '".PclZipUtilOptionText($p_options_list[$i])."'");
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Отсутствует параметр ".PclZipUtilOptionText($key)."(".$key.")");
...
if (($v_zip_temp_fd = @fopen($v_zip_temp_name, 'wb')) == 0)
{
  ...
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Не могу открыть временной файл \''.$v_zip_temp_name.'\' в режиме двоичной записи');
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'ZIP-файл \''.$this->zipname.'\' уже открыт');
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Не могу окрыть архив \''.$this->zipname.'\' в '.$p_mode.' режиме');
...
PclZip::privErrorLog(PCLZIP_ERR_MISSING_FILE, "Файл '$p_filename' не существует");
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Неверный список файлов (неверный или пустой список)");
...
if (($v_file = @fopen($p_filename, "rb")) == 0) {
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, "Не могу открыть файл '$p_filename' в режиме двоичного чтения");
  //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, PclZip::errorCode(), PclZip::errorInfo());
  return PclZip::errorCode();
}
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Не могу открыть архив \''.$this->zipname.'\' в режиме двоичного чтения');
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_INVALID_ARCHIVE_ZIP, 'Неверный размер архива');
...
if ($v_data['id'] != 0x04034b50)
{
  ...
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'Неверная структура архива');
...
if (strlen($v_binary_data) != 26)
{
  ...
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Неверный размер блока : ".strlen($v_binary_data));
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'Не могу перейти в конец архива \''.$this->zipname.'\'');
...
if ($v_size > 26) {
  ...
  {
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'Не могу возвратиться к середине архива \''.$this->zipname.'\'');
...
// ----- Error log
PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Не могу найти конец CDR сигнатуры");
...
if (strlen($v_binary_data) != 18)
{
  ...
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Неверный размер CDR : ".strlen($v_binary_data));
...
if (($v_pos + $v_data['comment_size'] + 18) != $v_size)
{
  ...
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Не могу найти right сигнатуру");
...
{
  // ----- Error log
  PclZip::privErrorLog(PCLZIP_ERR_DIR_CREATE_FAIL, "Не могу создать каталог '$p_dir'");
...
if (($v_zip_temp_fd = @fopen($v_zip_temp_name, 'wb')) == 0)
{
  ...
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Не могу открыть временный файл \''.$v_zip_temp_name.'\' в режиме двоичной записи');
...
if (($v_zip_temp_fd = @fopen($p_archive_filename, 'rb')) == 0)
{
  ...
  PclZip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Не могу открыть архивный файл \''.$p_archive_filename.'\' в режиме двоичной записи');
