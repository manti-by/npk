	...
	*/
	function getPagesLinks() {
		...
		if ($this_page > 1) {
			...
			$html .= "\n<a href=\"#beg\" class=\"pagenav\" title=\"первая страница\" onclick=\"javascript: document.adminForm.limitstart.value=0; document.adminForm.submit();return false;\"><< Начало</a>";
			...
			$html .= "\n<span class=\"pagenav\"><< Начало</span>";
		...
		if ($this_page < $total_pages) {
			...
			$html .= "\n<a href=\"#end\" class=\"pagenav\" title=\"последняя страница\" onclick=\"javascript: document.adminForm.limitstart.value=$end_page; document.adminForm.submit();return false;\"> В конец>></a>";
		} else {
			$html .= "\n<span class=\"pagenav\">Следующая ></span>";
			$html .= "\n<span class=\"pagenav\">Конец >></span>";
		}
		return $html;
	}
...
* @return string
*/
	function orderUpIcon( $i, $condition=true, $task='orderup', $alt='Двигать вверх' ) {
...
* @return string
*/
	function orderDownIcon( $i, $n, $condition=true, $task='orderdown', $alt='Двигать вниз' ) {
