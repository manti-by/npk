...
<head>
	<title>Предпросмотр голосований</title>
...
<table align="center" width="90%" cellspacing="2" cellpadding="2" border="0" >
	...
	<tr>
		<td valign="middle" height="50" colspan="2" align="center"><input type="button" name="submit" value="Голосовать">&nbsp;&nbsp;<input type="button" name="result" value="Результаты"></td>
	</tr>
	<tr>
